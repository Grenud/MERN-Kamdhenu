...
function Navbar() {
  ...
  return (
    <>
      <div
        className={`bg-light ${
          isScrolled ? "md:bg-light text-secondary" : "md:bg-transparent"
        } p-2 fixed top-0 w-full z-50 `}
      >
        <div className="max-w-[1240px] flex items-center justify-between py-[2px] md:py-[15px] mx-auto">
          ...
          <ul className={`hidden md:flex ${!isScrolled ? 'text-secondary' : 'text-secondary'} gap-10 ml-auto items-center mr-10`}>
          ...
          {/* Responsive menu */}
          <ul
            className={`duration-300 md:hidden w-3/4 h-screen text-secondary fixed bg-white top-[60px] ${
