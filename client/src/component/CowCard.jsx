import gautama1 from '../assets/Gaumata5.jpeg'
function CowCard() {
  return (
    <section className='bg-light text-neutral-800 rounded-lg overflow-hidden p-2  flex flex-col gap-2'>
      ...
      <img src={gautama1} alt="gautama" className='hover:scale-105 duration-300' />
      </figure>
      <h2 className='font-semibold tracking-wide text-xl'>Help us to Care Sharaddha Gaumata</h2>
