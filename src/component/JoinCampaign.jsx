    ...
    <div className="relative min-h-screen py-16 px-4 md:px-8 overflow-hidden bg-gray-100">
      ...
      <div className="relative z-10 mt-0 md:mt-10 text-center">
        ...
        <div className="max-w-6xl mx-auto p-0 md:p-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <motion.div 
            className="shadow-xl rounded-lg bg-transparent hover:scale-105 duration-500 flex flex-col items-center border-2 border-gray-600 hover:border-[#6d9051] p-4" 
            initial={{ opacity: 0 }} 
            whileInView={{ opacity: 1 }} 
            transition={{ duration: 0.5, delay: 0.75, ease: "easeOut" }}
          >
            <FaHeart className="text-4xl md:text-6xl text-[#6d9051]" />
            <div className="text-center mt-4 text-black">
              <h2 className="text-xl md:text-2xl font-semibold">Adopt</h2>
              <p className="mt-2 text-sm md:text-base">We provide Calves, Cows and Bulls ready for Adoption</p>
            </div>
          </motion.div>
          <motion.div 
            className="shadow-xl rounded-lg bg-transparent hover:scale-105 duration-500 flex flex-col items-center border-2 border-gray-600 hover:border-[#6d9051] p-4" 
          ...
          >
            <IoPerson className="text-4xl md:text-6xl text-[#6d9051]" />
            <div className="text-center mt-4 text-black">
          ...
          >
            <FaDonate className="text-4xl md:text-6xl text-[#6d9051]" />
            <div className="text-center mt-4 text-black">
