          ...
          {coverImageData.map((item, index) => (
            <div key={index} className="flex-shrink-0 w-full relative">
              <img
                ...
                alt={item.altText} // Ensure alt text is descriptive
              />
              ...
              <div className="absolute inset-0 flex flex-col items-start ml-[20px] md:ml-[50px] justify-center top-[15%] text-gray-300 text-center">
                ...
                <button
                  className="py-2 text-sm md:py-3 px-6 md:px-10 rounded-md bg-green-800 font-semibold hover:bg-green-600 transition-colors border border-[#213547] duration-200 ease-in focus:outline-none focus:ring-2 focus:ring-green-500"
