...
function CowPuja() {
  const handleAddToCart = () => {
    // Logic for adding the item to cart can be implemented here
    console.log("Cow Puja added to cart!");
  };
  ...
  return (
    <div className='container mx-auto mt-20 px-4 md:px-6 mb-20 lg:px-8'>
      <div className='p-4 md:grid grid-cols-1 md:grid-cols-3 gap-6 shadow-2xl rounded-lg'>
        <div className='col-span-1 text-center bg-white shadow-md rounded-lg p-5'>
          <img 
            className='w-full h-auto rounded-lg'
            src='https://kamdhenuseva.com/wp-content/uploads/2023/01/gai-tihar-300x197-1.jpg' 
            alt='Cow Puja performed with reverence and tradition'
          ...
          <div className='flex justify-center mt-4'>
            <button 
              className='flex items-center bg-[#6d9051] text-white px-4 py-2 rounded-lg hover:bg-[#5a7b3d] transition duration-300 ease-in-out'
              onClick={handleAddToCart}
              aria-label="Add Cow Puja to cart"
            >
        ...
        <div className='col-span-1 md:col-span-2 flex flex-col justify-center mt-6 md:mt-0'>
          ...
          <p className='text-justify text-gray-700 leading-relaxed'>
            ...
            <a href="mailto:welcome@kamdhenuseva.com" className='text-[#6d9051] hover:underline'>
